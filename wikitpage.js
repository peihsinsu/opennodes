var config={
  ...
  project:'opennodes', //The github project name, that will use for build edit link
  ...
  welcome_page: '../README.md', //The welcome page, default location that access from root url
